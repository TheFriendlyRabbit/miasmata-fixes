...
def translate_clip(layer, xxx_todo_changeme, xxx_todo_changeme1):
    ((fx1, fy1), (fx2, fy2)) = xxx_todo_changeme
    ((tx1, ty1), (tx2, ty2)) = xxx_todo_changeme1
    ((fx1, fy1), (fx2, fy2)) = \
...
def update_in_world_note(image, note, xxx_todo_changeme2, mask_layer, offset):
    ...
    try:
        ...
        print(
            'SKIPPING IN-WORLD VERSION OF %s - LARGE VERSION NOT FOUND' % note)
        return
...
register(
    ...
    None,
    [
        (PF_STRING, "input_dir", "Directory with the blank templates to use",
         None),
    ],
    [],
