...
txt_scanning = QApplication.translate('exe patcher',
                                      'Scanning Miasmata.exe for translatable '
                                      'strings...',
                                      None)
txt_success = QApplication.translate('exe patcher', 'Patch successful', None)
txt_err = QApplication.translate('exe patcher',
                                 '%s occurred writing to Miasmata.exe: %s',
                                 None)
...
def get_rdata(pe):
    return [x for x in pe.sections if x.Name == '.rdata\0\0'][0]
